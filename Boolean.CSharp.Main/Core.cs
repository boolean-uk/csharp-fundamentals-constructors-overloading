...
namespace Boolean.CSharp.Main
{
    public class Core
    {
        ...
        {     
            /*
                Examine the code in the Car class.  There are 2 constructor methods, identified because they have the same name as the class which in this case is Car..
            ...
            */
            ...
            /*  
             When the car in instantiated, the constructor is passed a string, in this case Volkswagen which is a Make of car is passed in.
        ...
        public bool Question2()
        {
            ...
            // Note there are two contructors.  
        ...
        {
            // Examine the Bicycle class. See there is somewhere to store the number of wheels the bike has, but no constructor to set this
        ...
        {
            // Examine the Unicycle class. A unicycle is a bike with one wheel
            ...
            // TIP  see we already have an internal member for the unicyclist name:  _nameOfUnicyclist so you can use this to store the name internally, it is good practice to name internal class variable with an _ at the beginning

            Unicycle unicycle = new Unicycle("Your Name");
