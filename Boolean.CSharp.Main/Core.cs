...
namespace Boolean.CSharp.Main
{
    public class Core
    {
        ...
        public Aeroplane Question5()
        {
            ...
            //TIP  as soon as you type plane.FlightDetails() Visual Studios intellisense will present you with a dialog
            //where you can see how many overloads there are

            //write code here and inside the Aeroplane class
            plane.FlightDetails("This flight has been cancelled");
            return plane;
        }
