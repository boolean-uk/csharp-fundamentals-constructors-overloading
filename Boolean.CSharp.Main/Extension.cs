...
namespace Boolean.CSharp.Main
{
    ...
    {       
        ...
        public string subtract(string a, char b) { return a.Replace("z", ""); }
        ...
        public string multiply(string a, int b) { return string.Join(',', Enumerable.Repeat(a, b).ToArray()); }
        ...
        public int[] multiply(String[] a, int b) { return a.Select(num => b * Int32.Parse(num)).ToArray(); }
    }
}