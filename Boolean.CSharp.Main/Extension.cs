...
namespace Boolean.CSharp.Main
{
    public class Extension
    {
        ...
        {
            return inputString.Replace(charToRemove.ToString(), string.Empty);
        }
        ...
        public string multiply(string inputString, int repeatCount)
        {
            return string.Join(",", new string[repeatCount].Select(_ => inputString));
        }
        ...
        {
            return Array.ConvertAll(stringNumbers, s => int.Parse(s) * multiplier);
        }
    }
}
